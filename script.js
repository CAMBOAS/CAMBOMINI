const products = [
  ...
  {
    id: 2,
    name: "សាប៊ូកក់ និងម៉ាសសក់ VIP 5in1 CCR",
    price: 16,
    category: "Hair",
  ...
  {
    id: 3,
    name: "សាប៊ូកក់ និងម៉ាសសក់ Premium CCR",
    price: 16,
    category: "Hair",
...
function initTheme() {
  ...
  const savedTheme = localStorage.getItem("camboTheme") || "light";
  document.body.classList.toggle("dark", savedTheme === "dark");
  els.themeToggle.textContent = savedTheme === "dark" ? "🌙" : "☀️";

  els.themeToggle.addEventListener("click", () => {
    const isDark = document.body.classList.toggle("dark");
    localStorage.setItem("camboTheme", isDark ? "dark" : "light");
